        ...
        async login() {
                ...
                try {
                        ...
                        await Promise.all([
                                ...
                                page.click(BCASelectors.LOGIN_PAGE.submitButton),
                        ]);
        ...
        async getSettlement(tglawal, blnawal, tglakhir, blnakhir) {
                ...
                if (!page){
                        ...
                        try {
                                ...
                                request.post({
                                        url: 'https://toptiershop.id/api/v1/webhook/cekmutasi',
                                        body: resultsettlement["transactions"],
                                        json: true
